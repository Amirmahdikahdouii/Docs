...
![Client and network layers](./assets/client-and-network.png)
...
![Front end layer](./assets/frontend-layer.png)
...
![Query Execution engine](./assets/query-executor.png)
...
![Transaction manager](./assets/transaction-manager.png)
